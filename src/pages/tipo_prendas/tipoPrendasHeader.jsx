...
export default function TipoPrendasHeader({
  busqueda,
  setBusqueda,
  filtroEstado,
  setFiltroEstado,
  ...
  return (
    <div className="tm-users__header">
      <div>
        ...
        <p>Listado de tipos de prenda registrados en el sistema.</p>
      </div>
